...
let {marca_buscar} = require('../../querys/producto/buscar_marcas');
///////ESPACIO PARA FUNCIONES GENERALES

////ESPACIO PARA LOS MANEJOS DE ERRORES CON RESPUESTA
const {error_corrector} = require('../error/err1')

async function buscar_marcas(req,res,next) {
    try{
...
function consulta2(conexion,req,next){
    return new Promise((resolve,reject)=>marca_buscar(resolve,reject,conexion,req,next))
}
