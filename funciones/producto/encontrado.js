...
let {producto_encontrado} = require('../../querys/producto/encontrar')
///////ESPACIO PARA FUNCIONES GENERALES

////ESPACIO PARA LOS MANEJOS DE ERRORES CON RESPUESTA
const {error_corrector} = require('../error/err1')

async function encontrado(req,res,next) {
    try{
...
function consulta2(conexion,req,next){
    return new Promise((resolve,reject)=>producto_encontrado(resolve,reject,conexion,req,next))
}
