...
let {reporte_tiempo} = require('../../querys/reportes/reporte_tiempo')
...
async function marcas_tiempo(req,res,next) {
    try{
...
function consulta3(conexion,body){ return new Promise((resolve,reject)=>reporte_tiempo(resolve,reject,conexion,body)) }
