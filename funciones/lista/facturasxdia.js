...
let {fac_dia_elegido} = require('../../querys/lista/factura_dia_elegido')
///////ESPACIO PARA FUNCIONES GENERALES

////ESPACIO PARA LOS MANEJOS DE ERRORES CON RESPUESTA
const {error_corrector} = require('../error/err1')

async function facturaxdiaxelegido(req,res,next) {
    try{
...
function consulta2(conexion,galleta,body){ return new Promise((resolve,reject)=>fac_dia_elegido(resolve,reject,conexion,galleta,body)) }
...
module.exports={facturaxdiaxelegido}