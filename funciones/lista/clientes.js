...
let {seleccion_clientes} = require('../../querys/lista/lista_clientes')
///////ESPACIO PARA FUNCIONES GENERALES

////ESPACIO PARA LOS MANEJOS DE ERRORES CON RESPUESTA
const {error_corrector} = require('../error/err1')

async function clientes_atendidos(req,res,next) {
    try{
...
function consulta2(conexion,galleta,body){ return new Promise((resolve,reject)=>seleccion_clientes(resolve,reject,conexion,galleta,body)) }
...
module.exports={clientes_atendidos}