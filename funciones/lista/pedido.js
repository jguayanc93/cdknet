...
let {pedi_de_hoy} = require('../../querys/lista/pedidohoy')
///////ESPACIO PARA FUNCIONES GENERALES

////ESPACIO PARA LOS MANEJOS DE ERRORES CON RESPUESTA
const {error_corrector} = require('../error/err1')

async function pedidoxdia(req,res,next) {
    try{
...
function consulta2(conexion,galleta){ return new Promise((resolve,reject)=>pedi_de_hoy(resolve,reject,conexion,galleta)) }
