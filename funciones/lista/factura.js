...
let {fac_de_hoy} = require('../../querys/lista/facturahoy')
///////ESPACIO PARA FUNCIONES GENERALES

////ESPACIO PARA LOS MANEJOS DE ERRORES CON RESPUESTA
const {error_corrector} = require('../error/err1')

async function facturaxdia(req,res,next) {
    try{
...
function consulta2(conexion,galleta){ return new Promise((resolve,reject)=>fac_de_hoy(resolve,reject,conexion,galleta)) }
