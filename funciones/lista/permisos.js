...
async function lista_permisos(req,res,next) {
    try{
...
function ver_permisos(resolve,reject,payload,tipo,req,next){
    ...
    for(const access of Object.keys(permisos["lista"])){
        if(permisos["lista"][access].includes(parseInt(grupo))){
