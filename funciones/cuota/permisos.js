...
async function cuota_permisos(req,res,next) {
    try{
...
function ver_permisos(resolve,reject,payload,tipo,req,next){
    ...
    for(const access of Object.keys(permisos["cuota"])){
        if(permisos["cuota"][access].includes(parseInt(grupo))){
