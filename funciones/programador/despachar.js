...
async function despacharxdia(req,res,next) {
    try{
...
function consulta2(conexion,galleta){ return new Promise((resolve,reject)=>despacho_de_hoy(resolve,reject,conexion,galleta)) }
