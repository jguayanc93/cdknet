...
let {factura_info_direccion} = require('../../querys/factura/direccion')
///////ESPACIO PARA FUNCIONES GENERALES

////ESPACIO PARA LOS MANEJOS DE ERRORES CON RESPUESTA
const {error_corrector} = require('../error/err1')

async function facturaxdireccion(req,res,next) {
    try{
...
function consulta2(conexion,galleta,body){ return new Promise((resolve,reject)=>factura_info_direccion(resolve,reject,conexion,galleta,body)) }
...
module.exports={facturaxdireccion}