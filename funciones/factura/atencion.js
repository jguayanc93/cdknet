...
let {factura_info_atencion} = require('../../querys/factura/atencion')
///////ESPACIO PARA FUNCIONES GENERALES

////ESPACIO PARA LOS MANEJOS DE ERRORES CON RESPUESTA
const {error_corrector} = require('../error/err1')

async function facturaxatencion(req,res,next) {
    try{
...
function consulta2(conexion,galleta,body){ return new Promise((resolve,reject)=>factura_info_atencion(resolve,reject,conexion,galleta,body)) }
...
module.exports={facturaxatencion}