...
let {factura_info_transportista} = require('../../querys/factura/transportista')
///////ESPACIO PARA FUNCIONES GENERALES

////ESPACIO PARA LOS MANEJOS DE ERRORES CON RESPUESTA
const {error_corrector} = require('../error/err1')

async function facturaxtransportista(req,res,next) {
    try{
...
function consulta2(conexion,galleta,body){ return new Promise((resolve,reject)=>factura_info_transportista(resolve,reject,conexion,galleta,body)) }
...
module.exports={facturaxtransportista}