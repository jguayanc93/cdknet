...
let {factura_sugerencia_atencion} = require('../../querys/factura/atencion_sugerencia')
///////ESPACIO PARA FUNCIONES GENERALES

////ESPACIO PARA LOS MANEJOS DE ERRORES CON RESPUESTA
const {error_corrector} = require('../error/err1')

async function facturaxatencionxsugerencia(req,res,next) {
    try{
...
function consulta2(conexion,body){ return new Promise((resolve,reject)=>factura_sugerencia_atencion(resolve,reject,conexion,body)) }
...
module.exports={facturaxatencionxsugerencia}