...
let cabecera_corregido = (resolve,reject,conexion,montos)=>{
    ...
    consulta.addParameter('totalisado',TYPES.VarChar,montos[1].toString());
    consulta.addParameter('totaligv',TYPES.VarChar,montos[2].toString());
    consulta.addParameter('totalconigv',TYPES.VarChar,montos[3].toString());
